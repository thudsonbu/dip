 ...
 * of stones is odd, so there are no ties. Alex and Lee take turns, with Alex
 * starting first.  Each turn, a player takes the entire pile of stones from
 * either the beginning or the end of the row. This continues until there are
